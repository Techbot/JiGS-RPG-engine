...
<template>
  <div class="inventory">
    <img src="/assets/images/gui/header.png" />
    <div class="row">
      <div class="col">
        <h3>Storage</h3>
        <draggable class="inventory__storage list-group" :list="jigs.listStorage" group="people"
          ...
          <template #item="{ element, index }">
            <div class="inventory__item list-group-item">
              ...
              <img src="/assets/images/gui/W_Sword017.png" alt="" width="34" height="34"/>
            </div>
          </template>
        </draggable>
      </div>
        ...
        <draggable class="inventory__backpack list-group" :list="jigs.listBackpack" group="people"
          ...
          <template #item="{ element, index }">
            <div class="inventory__item list-group-item">
              ...
              <img src="/assets/images/gui/W_Gold_Mace.png" alt="" width="34" height="34"/>
            </div>
          </template>
        </draggable>
      </div>
