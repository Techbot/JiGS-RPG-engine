...
export class HudScene extends Scene {
  ...
  create() {
    ...
    ourGame.events.on('Pope Turlock', function () {
      this.DialogThing();
    }, this);
  ...
  DialogThing = function () {
    ...
    var dialog = this.rexUI.add.dialog({
      ...
      background: this.rexUI.add.roundRectangle(0, 0, 100, 100, 20, 'rgba(0, 0, 0, 0.6)'),
      title: createLabel(this, 'Mr. Blue').setDraggable(),
      //      toolbar: [
      //        createLabel(this, 'O'),
      //        createLabel(this, 'X')
      //      ],
      ...
      //       createLabel(this, 'B')
      //     ],
      content: createLabel(this, `With the JiGS engine, these two steps (while not trivial) are  \n
         ball thats required by the Games master to create an entirely new gameworld.Want magic ?\n
         Create wands, agic stats, magical NPCs, bulidings and Cities in Drupal.\n
         Then create the battles and interactions in Mysql files called subscribers.`),

      // description: createLabel(this, 'With the JiGS engine, these two steps (while not trivial) are all thats required by the'),

      choices: [
        createLabel(this, '1. With the JiGS engine, these '),
        createLabel(this, '2. nd add them to the subscription list.A few yea'),
        createLabel(this, '3. drop these subscriber')
      ],

      actions: [
        createLabel(this, 'Leave'),
