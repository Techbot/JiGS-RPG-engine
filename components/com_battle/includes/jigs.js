					...
					var a = new Request.JSON(
							{
								...
								onSuccess : function(result) {
									...
									var a = new Request.JSON(
											{
												url : "index.php?option=com_battle&format=raw&task=action&action=get_cells&map="
														+ map,
												onSuccess : function(result) {
													for (i = 0; i < 8; i++)
														mycells[i] = new Array(
													...
													mycells[0] = result[0]['row0']
															.split(',');
													mycells[1] = result[0]['row1']
															.split(',');
													mycells[2] = result[0]['row2']
															.split(',');
													mycells[3] = result[0]['row3']
															.split(',');
													mycells[4] = result[0]['row4']
															.split(',');
													mycells[5] = result[0]['row5']
															.split(',');
													mycells[6] = result[0]['row6']
															.split(',');
													mycells[7] = result[0]['row7']
															.split(',');
													...
													var a = new Request.JSON(
															{
																url : "index.php?option=com_battle&format=raw&task=action&action=get_portals&map="
																		+ map,
																onSuccess : function(
																		result) {
