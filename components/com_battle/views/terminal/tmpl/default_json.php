...
<tr><td>id:</td><td>$id </td><td>Level:</td><td>$level</td>
<td>ip:::::</td><td>$ip</td></tr><tr><td>bandwidth:</td><td>$bandwidth</td><td>capacity:</td><td>$capacity</td>
    <td>version:</td><td>$version</td>
</tr><tr><td>status:</td><td>$status</td><td>faction:</td><td>$faction</td>
    <td>battery</td><td>$battery</td></tr></table><div id='action' class='clearfix' style = 'font-size:10px;'>
