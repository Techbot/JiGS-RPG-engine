...
playState[10] = {
    ...
    preload: function() {
        ...
        game.load.image('Southern-Symbols', '/components/com_battle/images/assets/cutnpaste/Southern-Symbols.png');
    ...
    create: function() {
        ...
        game.load.image(cacheKey('B-E_HF1R_Dungeon_1', 'tileset', 'B-E_HF1R_Dungeon_1'), '/components/com_battle/images/assets/B-E_HF1R_Dungeon_1');
