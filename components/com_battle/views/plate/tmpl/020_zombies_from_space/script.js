...
function update () {
    if (game.input.activePointer.isDown) {
       ...
       //this.physics.arcade.collide(bobh, obj004, jump);
  ...
  //  game.physics.arcade.moveToXY(obj004, x, y, 100);
    ///////////////////// Stop Player
/*
    if ((obj004.body.x >=x-10) &&(obj004.body.x <=x+10)){
        obj004.body.velocity.x = 0;
        //console.log('x:' +sprite.body.velocity.x);
    }
    if ((obj004.body.y >=y-10) &&(obj004.body.y <=y+10)){
        obj004.body.velocity.y = 0;
    }
    if ((obj004.body.velocity.x == 0)&&(obj004.body.velocity.y == 0)) {
