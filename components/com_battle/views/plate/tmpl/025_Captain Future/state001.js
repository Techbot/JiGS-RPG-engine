// defining a single global object (captain_future) and adding some functions in to its prototype (eg preload, create functions)
...
captain_future.State001 = function (game) {


};

captain_future.State001.prototype = {
    ...
    preload: function () {
        ...
        game.load.atlas('sprite2', 'sprite.png', 'sprite.json');
        game.load.image('spin1', '9b8f8f29f125515492c0e69d6063f09c.png');
        game.load.image('spin2', 'spinObj_02.png');
        //   game.load.image('spin3', 'spinObj_03.png');
    ...
    create: function () {
        ...
        obj002 = game.add.sprite(-27, 122, 'sprite2', 'object002');
...
function addtext(){
    ...
    text1 = game.add.text(game.world.centerX -170, game.world.centerY, ' Temporary Strength Boosts ', {/*style*/}, text);
    text2 = game.add.text(game.world.centerX, game.world.centerY, '', { fill: '#ff00ff', font: "50px Arial",strokeThickness:8, stroke:'#ff0000' }, text);
    text3 = game.add.text(game.world.centerX +190, game.world.centerY, '', { fill: '#ff00ff', font: "50px Arial",strokeThickness:8, stroke:'#ff0000' }, text);
