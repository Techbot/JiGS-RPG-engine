...
<input type="button" class="quantity_box_button quantity_box_button_up" onclick="var qty_el = document.getElementById('hobbits_total'); var qty = qty_el.value; if( !isNaN( qty )) qty_el.value++;changeCrops();return false;" value="+" />
