...
<h2>:<span id = 'primary_hobbits'> <?php echo $this->building_hobbit_stats->free; ?></span>:</h2>
...
var paper = Raphael("test", 150, 100);
...
// document.getElementById("result1").innerHTML="Last name: " + localStorage.lastname; 
