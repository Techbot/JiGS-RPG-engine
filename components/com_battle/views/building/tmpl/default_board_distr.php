...
<form class="primary_0" action="index.php" method="get" name="adminForm_0" id= "adminForm_0">	
	...
	<span id= "assign_distribution" class="assign button btn btn-success">Assign Hobbit</span>
	<span id= "remove_distribution" class="remove button btn btn-danger">Remove Hobbit</span>
</form>	
<br />
