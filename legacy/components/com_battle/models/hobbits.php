...
class BattleModelHobbits extends JModelLegacy
{
	var $_data = null;
    ...
    {
        $building_id = JRequest::getvar('id');
        ...
        $query = "SELECT name FROM #__jigs_hobbits WHERE section = 0 AND owner = $building_id";
        $db->setQuery($query);
