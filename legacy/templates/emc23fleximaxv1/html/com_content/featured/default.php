...
?>
<div class="row-fluid blog-featured<?php echo $this->pageclass_sfx;?>">
...
if ($this->columns == "4") {
		...
		<?php endif; ?>
		<div class="item column-<?php echo $rowcount;?><?php echo $item->state == 0 ? ' system-unpublished"' : null; ?> <?php echo 'span'.$rowspan ; ?>">
			<?php
					$this->item = &$item;
					echo $this->loadTemplate('item');
			?>
