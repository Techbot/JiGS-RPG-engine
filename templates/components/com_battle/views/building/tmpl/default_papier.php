...
function request_inventory(id){
    ...
    url: "index.php?option=com_battle&format=raw&task=action&action=get_shop_papers&building_id=<?php echo $this->buildings->id ; ?>", 
...
function request_inventory2(){
 ...
 var all = '<table class="shade-table"><tbody>';
	...
	var a = new Request.JSON({
    url: "index.php?option=com_battle&format=raw&task=action&action=get_papers", 
    onSuccess: function(result){
