...
namespace Drupal\items\Form;

use Drupal\Core\Entity\BundleEntityFormBase;
use Drupal\Core\Form\FormStateInterface;
use Drupal\field_ui\FieldUI;

class ItemsTypeEntityForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\items\Entity\ItemsTypeEntityInterface $entity_type */
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\items\Entity\ItemsTypeEntity::load',
      ],
