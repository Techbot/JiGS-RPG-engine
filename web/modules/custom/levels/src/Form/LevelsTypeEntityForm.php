...
namespace Drupal\levels\Form;

use Drupal\Core\Entity\BundleEntityFormBase;
use Drupal\Core\Form\FormStateInterface;
use Drupal\field_ui\FieldUI;

class LevelsTypeEntityForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\levels\Entity\LevelsTypeEntityInterface $entity_type */
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\levels\Entity\LevelsTypeEntity::load',
      ],
