...
class BuildingsTypeEntityForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\buildings\Entity\BuildingsTypeEntityInterface $entity_type */
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\buildings\Entity\BuildingsTypeEntity::load',
      ],
