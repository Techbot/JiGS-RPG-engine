...
/**
 * Class BuildingsTypeListBuilder
 */
class BuildingsListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new BuildingsListBuilder object.
   *
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\buildings\Entity\BuildingsEntityInterface $entity */
